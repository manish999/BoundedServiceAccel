...
import in.manish.boundedservice.util.StringUtils;
...
public class MyService extends Service implements SensorEventListener, Runnable, CustomTimer.CustomTimerCallBack
{
	...
	private void doTask() {
		...
		if(isLastCall) {
			...
			if(timeCounter <= 0) {
				...
				updateNotification("Duration: "+totalReverseDuration);
